...
class HelpCommand extends UserCommand
{
     ...
     * @var string
     */
    protected $usage = '/help or /help <назва команди без />';
    ...
    public function execute()
    {
        ...
        if ($command_str === '') {
            $data['text'] = "Выдать сообщение (файл, фото, аудио) в ответ на определенное сообщение - !trigger [ответ на сообщение] (работает только с ответами)" . PHP_EOL;
            ...
            $data['text'] .= PHP_EOL . 'Довідка по конкретній команді: /help <назва команди без />';
        ...
        $data['text'] = 'Нічіим не можемо допомогти: команда /' . $command_str . ' відсутня';
